...
if __name__	 == '__main__':
	...
	for count, model in enumerate( models ):
		...
		for j, args in zip( file_groups[ model ], args_list[ count ] ):
			...
			if isinstance( veg_dd[ domain_name ][ 'Black Spruce' ], pd.DataFrame ):
				...
				# plot it
				generate( ax, modeled_mean, modeled_min, modeled_max, label=label, linecolor=k, rangecolor=l, alpha=0.2, line_zorder=m, linestyle=s )
	...
	plt.savefig( '/workspace/Shared/Tech_Projects/SERDP/project_data/ALFRESCO/SERPD_run/AMY_SERDP_2016/ALFRESCO_CD_ratios_'+'overlay'+'_'+scenario+'_iqr_ju_edit.png', figsize=figsize, dpi=600, bbox_inches='tight', pad_inches=0.2 )
	plt.close( 'all' )
