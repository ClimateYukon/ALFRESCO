...
def decade_plot(scenario1 , observed , output_path ,  model , graph_variable, year_range , *args):
...
def launcher(  ) :
    ...
    out = '/atlas_scratch/jschroder/IEM_2017_SouthBoreal/'
    ...
    output_path = '/workspace/Shared/Users/jschroder/TMP/BSing2'
    ...
    for metric in scenario1.metrics :
        if metric not in [ 'veg_counts' , 'all_fire_sizes']:
            decade_plot(scenario1 , observed , output_path ,  model , metric, year_range)
