...
if __name__ == '__main__':
	...
	output_base_path = '/atlas_scratch/jschroder/IEM_2017/ALF_IEM'
	scenarios = ['rcp45', 'rcp60' , 'rcp85']
	models = ['CCSM4', 'GFDL-CM3', 'IPSL-CM5A-LR', 'MRI-CGCM3', 'GISS-E2-R']
	script_path = '/home/UA/jschroder/src/alfresco-calibration-alfresco-postprocessing/alfresco_postprocessing/bin/alfresco_relative_vegetation_change.py'
